<?php
    $youtube_email = "mythclansite@gmail.com"; // Change this to your youtube sign in email.
    $youtube_password = "qwerty0987654321"; // Change this to your youtube sign in password.
    // Developer key: Get your key here: http://code.google.com/apis/youtube/dashboard/.
    $key = "AI39si56ZUl-RBKyYI45DGHXgrAQcLmYKsuvuEGJ48C91i93WxRMnVuTN5CrfJG7HXTTk6Flp7GvRIVT_6Fm2p7mzwNWhVeROA"; 
    
    $source = 'mythclan'; // A short string that identifies your application for logging purposes.
    ...
    $youtube_video_keywords = "mythclan"; // This is the uploading video keywords.
    $youtube_video_category = "Nonprofit"; // This is the uploading video category. There are only certain categories that are accepted. See below 
    /* 
     * Accepted Categories:
     * 
        Film
